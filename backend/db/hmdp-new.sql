/*
 ...
 Review Merge          : 2026-05-05, adds MySQL 8.0 review indexes
*/
...
CREATE TABLE `tb_blog`  (
  ...
  KEY `idx_blog_user_time` (`user_id`, `create_time` DESC, `id` DESC) USING BTREE,
  KEY `idx_blog_liked_id` (`liked` DESC, `id` DESC) USING BTREE
...
CREATE TABLE `tb_follow`  (
  ...
  KEY `idx_follow_follow_user` (`follow_user_id`, `user_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `tb_voucher`  (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_voucher_shop_status` (`shop_id`, `status`, `id`) USING BTREE
...
CREATE TABLE `tb_kb_document`  (
  ...
  KEY `idx_kb_document_status` (`status`) USING BTREE,
  KEY `idx_kb_document_update_time` (`update_time` DESC, `id` DESC) USING BTREE,
  KEY `idx_kb_document_file_id` (`file_path`, `id`) USING BTREE
...
CREATE TABLE `tb_kb_ingest_job`  (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_kb_job_started_time` (`started_time` DESC, `id` DESC) USING BTREE
